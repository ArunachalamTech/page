...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        safe_format_dict = create_safe_format_dict(basic_format_dict, file_name, file_captionx, user_id=m.from_user.id)
        ...
        if caption_position == "links":
            ...
            formatted_caption = c_caption.format(**safe_format_dict)
